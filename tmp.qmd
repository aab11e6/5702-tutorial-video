...
![](https://wikimedia.org/api/rest_v1/media/math/render/svg/1d1c4e1959722b56ce5e5841b9dc3167ec9072b3){fig-align="center"}
...
Let's use the close price of AAPL from 2019/01/01 to 2022/12/31 in this experiment. Here, we can use the **`auto.arima()`** function, which adjusts the pdq parameters based on the AIC method we've previously learned. If the model's fit is not good, we can also adjust the parameters by observing the ACF and PACF.
